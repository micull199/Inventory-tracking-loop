...
def test_manager_creates_views_archives_and_unarchives_an_item(
    ...
    pending_row = admin_page.locator('[data-testid="user-row"]', has_text="items-mgr@uc.test")
    ...
    promoted_row = admin_page.locator('[data-testid="user-row"]', has_text="items-mgr@uc.test")
    ...
    items_e2e_row = mgr_page.locator('[data-testid="taxonomy-row"]', has_text="Items E2E Cat")
    items_e2e_row.get_by_test_id("open-fields").click()
    mgr_page.wait_for_url(
        lambda u: u.startswith(f"{app_server}/admin/taxonomy/") and u.endswith("/fields")
    )
    ...
    expect(mgr_page.get_by_test_id("item-custom-fields")).not_to_be_visible()
    ...
    item_row = mgr_page.locator('[data-testid="item-row"]', has_text="ITE-0001")
    expect(item_row).to_be_visible()
    expect(item_row.get_by_test_id("item-name")).to_have_text("Silver wire (e2e)")
    expect(item_row.get_by_test_id("item-category")).to_have_text("Items E2E Cat")
    ...
    expect(mgr_page.get_by_test_id("item-cf-alloy-input")).to_have_value("silver")
    ...
    mgr_page.wait_for_url(f"{app_server}/admin/items")
    expect(mgr_page.locator('[data-testid="item-row"]', has_text="ITE-0001")).to_have_count(0)
    ...
    archived_row = mgr_page.locator('[data-testid="item-row"]', has_text="ITE-0001")
    expect(archived_row).to_be_visible()

    # Step 11: Unarchive — back to active.
    archived_row.get_by_test_id("unarchive-item").click()
    mgr_page.wait_for_url(f"{app_server}/admin/items")
    restored_row = mgr_page.locator('[data-testid="item-row"]', has_text="ITE-0001")
    ...
    item_row_after = mgr_page.locator('[data-testid="item-row"]', has_text="ITE-0001")
    ...
    mgr_page.wait_for_url(
        lambda u: u.startswith(f"{app_server}/admin/items/") and u.endswith("/units")
    )
    ...
    mgr_page.wait_for_url(
        lambda u: "/units/new" in u and u.startswith(f"{app_server}/admin/items/")
    )
    ...
    expect(mgr_page.locator('[data-testid="item-unit-row"]', has_text="SN-001")).to_be_visible()
    ...
    sn001_row = mgr_page.locator('[data-testid="item-unit-row"]', has_text="SN-001")
    sn001_row.get_by_test_id("archive-item-unit").click()
    mgr_page.wait_for_url(
        lambda u: u.startswith(f"{app_server}/admin/items/") and u.endswith("/units")
    )
    expect(mgr_page.locator('[data-testid="item-unit-row"]', has_text="SN-001")).to_have_count(0)
    mgr_page.get_by_test_id("tab-archived").click()
    mgr_page.wait_for_url(
        lambda u: "/units?show=archived" in u and u.startswith(f"{app_server}/admin/items/")
    )
    expect(mgr_page.locator('[data-testid="item-unit-row"]', has_text="SN-001")).to_be_visible()
    ...
    mgr_page.wait_for_url(f"{app_server}/admin/items")
    mgr_page.goto(f"{app_server}/admin/taxonomy")
    cat_row = mgr_page.locator('[data-testid="taxonomy-row"]', has_text="Items E2E Cat")
...
def test_admin_creates_qty_then_unique_item_end_to_end(
    ...
    item_row = admin_page.locator('[data-testid="item-row"]', has_text="ADM-0001")
    expect(item_row).to_be_visible()
    expect(item_row.get_by_test_id("item-category")).to_have_text("Admin Items E2E Cat")
    ...
    item_row_after = admin_page.locator('[data-testid="item-row"]', has_text="ADM-0001")
    item_row_after.get_by_test_id("edit-item").click()
    admin_page.wait_for_url(
        lambda u: u.startswith(f"{app_server}/admin/items/") and u.endswith("/edit")
    )
    ...
    expect(
        admin_page.locator('[data-testid="item-unit-row"]', has_text="AD-SN-001")
    ).to_be_visible()
    ...
    sn_row = admin_page.locator('[data-testid="item-unit-row"]', has_text="AD-SN-001")
    sn_row.get_by_test_id("archive-item-unit").click()
    admin_page.wait_for_url(
        lambda u: u.startswith(f"{app_server}/admin/items/") and u.endswith("/units")
    )
    admin_page.goto(f"{app_server}/admin/items")
    admin_page.locator('[data-testid="item-row"]', has_text="ADM-0001").get_by_test_id(
        "archive-item"
    ).click()
    admin_page.wait_for_url(f"{app_server}/admin/items")
    admin_page.goto(f"{app_server}/admin/taxonomy")
